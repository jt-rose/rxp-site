...
export const regexData: RegexDataObj[] = [
    ...
    },
    {
        ...
        description: "requires text to repeat at least the specified amount of times",
        example: "(?:sample){5, }",
    ...
    },
    {
        symbol: "{3, 6}",
        name: "occurs between",
        description: "requires text to repeat between the minimum and max range specified",
        example: "(?:sample){5, 8}",
